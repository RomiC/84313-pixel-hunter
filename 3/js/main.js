...
var statsTemplate$1 = getElementFromTemplate(statsTemplate);
...
const element$5 = getElementFromTemplate(game3Template);

const radioBtns$2 = Array.prototype.slice.call(element$5.querySelectorAll(`.game__option`));

radioBtns$2.forEach((radioBtn) => {
  radioBtn.addEventListener(`click`, () => {
    changeTemplate(statsTemplate$1, `on`);
  });
});
...
const element$4 = getElementFromTemplate(game2Template);

const radioBtns$1 = Array.prototype.slice.call(element$4.querySelectorAll(`input[type=radio]`));

radioBtns$1.forEach((radioBtn) => {
  radioBtn.addEventListener(`change`, () => {
    changeTemplate(element$5, `game`);
  });
});
...
let element$3 = getElementFromTemplate(game1Template);

const radioBtns = Array.prototype.slice.call(element$3.querySelectorAll(`input[type=radio]`));
...
element$1.querySelector(`.greeting__continue`).onclick = (event) => {
  event.preventDefault();
...
const changeTemplate = (template, modeHeader) => {
  ...
  const headerTemplate = element(modeHeader);
  if (headerTemplate) {
...
element$6.querySelector(`.intro__asterisk`).onclick = (event) => {
  event.preventDefault();
  changeTemplate(element$1);
};
